...
class ConfigMapzero(GeneralConfigModel):
    def __init__(self,type_interconnections,arch_dims,mode):
        ...
        enviroment = MapZeroEnviroment()
        model_instance_args = [10,7,32,4,arch_dims[0]*arch_dims[1],torch.float32,enviroment]
        dfg_class_name = EnumDFG.MAPZERO_DFG
        cgra_class_name = EnumCGRA.CGRA_MAPZERO
        super().__init__(type_interconnections,arch_dims,model_name,enviroment,MapZero,
