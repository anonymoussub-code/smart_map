...
class GeneralConfig_ONE_HOP(GeneralConfig):
    def __init__(self, model_name,enviroment,
        ...
        super().__init__(model_name,'ONE_HOP',EnumInterconnections.MESH,enviroment,
                         replay_buffer_size,num_simulations,dataset_range,arch_dims,
                         class_model,model_instance_args,
