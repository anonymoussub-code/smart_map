...
class SelfPlay:
    ...
    def __init__(self, initial_checkpoint, model, enviroment, config,initial_state, seed):
    ...
    def continuous_self_play(self, shared_storage,replay_buffer,test_mode=False,get_first_valid_solution=False):
                ...
                shared_storage.set_info.remote(
                    {
                        ...
                        "mapping_is_valid": game_history.observation_history[-1].mapping_is_valid
                    }
                )
    ...
    def play_game(
        ...
        with torch.no_grad():
            ...
            # Choose the action
                ...
                observation, reward, done = self.enviroment.step(root.state,action)
