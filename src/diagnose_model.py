...
class DiagnoseModel:
    ...
    #     self, observation, horizon, plot=True
    # ):
    #     """
    ...
    #         self.model, observation, observation.get_legal_actions(), True
    #     )
    ...
    #         if root.state.is_end_state:
    #             trajectory_info.store_info(
    #             root, mcts_info, action, reward.item(), new_prior_root_value=value
    #             )
    #             print('end',action,root.state.id_node_to_be_mapped)
    #             break
    #         root, mcts_info = MCTS(self.config).run(
    #             self.model, None, root.state.get_legal_actions(), True, root
    #         )
    #         trajectory_info.store_info(
    #             root, mcts_info, action, reward.item(), new_prior_root_value=value
    #         )
    ...
    def get_real_trajectories(
        self, first_obs, horizon, enviroment,plot=True,
    ):
        """
        ...
        for i in range(horizon):
            ...
            observation, reward, done = enviroment.step(state,action)
            if done:
